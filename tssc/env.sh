...
export IMAGE_URL=${IMAGE_URL-quay-quay-quay-test.apps.salamander.aimlworkbench.com/rhdh/konflux-app-test:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/deanpeterson/konflux-app-test-gitops
